...
function Home() {
  ...
  return (
    <>
      ...
      <section  id="home" className="home-top" data-aos="fade-in">
        ...
        <div className="intro-text">
          <h2>Hello, I'm</h2>
          <h1>Jeevan Varghese</h1>

          <p className="tagline">Aspiring Full Stack Web Developer</p>

          <p className="short-bio">
            Passionate about creating dynamic and responsive websites. Skilled in React, Node.js, and MongoDB.
            Always learning and pushing boundaries in web development.
          </p>
          ...
          <div className="home-actions" >
            ...
            <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=jeevanvarghese2020@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
              title="Send Email"
            ...
            <a
              href="https://www.instagram.com/jeevan_2105/"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section id="about" className="about-section" data-aos="fade-in">
        <About />
      </section>


      <section id="skills" className="skills-section" data-aos="fade-in">
        <Services />
      </section>

      <section id="projects" className="projects-section" data-aos="fade-in">
        <Projects />
      </section>

      <section id="experience" className="experience-section" data-aos="fade-in">
        <Experience />
      </section>

      <section id="resume" className="resume-section" data-aos="fade-in">
        <Resume />
      </section>
